...
public class PathIndicator : MonoBehaviour
{
    ...
    {
        transform.position = new Vector3(selectedUnit.GetComponentInChildren<MovementSystem>().tileX,
            selectedUnit.GetComponentInChildren<MovementSystem>().tileY, selectedUnit.transform.position.z);
    }
}